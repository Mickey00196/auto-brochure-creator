# Brochure Engine Importer (Chrome extension)

One-click import of the commercial listing you're currently viewing (e.g. a
funda in business object page) into the Real Estate Brochure Engine. It sends
...
logged in to the Brochure Engine in the same Chrome profile.
...
5. Pin it: puzzle-piece icon in the toolbar → pin "Brochure Engine Importer".

## Using it

1. Make sure the Brochure Engine is running and you're logged in to it in
...
**"You're not logged in".** Log in to the Brochure Engine app itself (the
